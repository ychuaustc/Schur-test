function [VertexU, t, iterARAP, iterSchur] = IterConjPre(MThetaLVX, MThetaLVY, MSS, MSE, MWW, MWE, MEE, MEE_W, solverMSS, ...
                                             LW, LE, dsInd, dwInd, deInd, Face, FXV, FYV, FCotTheta, EnULOld, nV, nF, ...
...
while 1
    ...
    = SchurConjPreSolver(MSS, MSE, MWW, MWE, MEE, MEE_W, LW, LE, CSX, CWX, bX, solverMSS, dsInd, dwInd, deInd, nV - 1, numDecompose, epsSchur);
    [YU, iter_Y{iterARAP}, t_Y{iterARAP}] ...
    = SchurConjPreSolver(MSS, MSE, MWW, MWE, MEE, MEE_W, LW, LE, CSY, CWY, bY, solverMSS, dsInd, dwInd, deInd, nV - 1, numDecompose, epsSchur);
