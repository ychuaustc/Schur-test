function [VertexU, t, iterARAP, iterSchur] = IterConj(MThetaLVX, MThetaLVY, MSS, MSE, MWW, MWE, MEE, solverMSS, ...
...
while 1
    ...
    = SchurConjSolver(MSS, MSE, MWW, MWE, MEE, CSX, CWX, bX, solverMSS, dsInd, dwInd, deInd, nV - 1, numDecompose, epsSchur);
    [YU, iter_Y{iterARAP}, t_Y{iterARAP}] ...
    = SchurConjSolver(MSS, MSE, MWW, MWE, MEE, CSY, CWY, bY, solverMSS, dsInd, dwInd, deInd, nV - 1, numDecompose, epsSchur);
