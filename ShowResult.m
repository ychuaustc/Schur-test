function [] = ShowResult(iterARAP_D, t_D, iterARAP_C, iterSchur_C, t_C, iterARAP_CP, iterSchur_CP, t_CP)
%
...
fprintf('The local-global iteration time is: direct solver: %d, CG solver: %d, PCG solver: %d \n', iterARAP_D, iterARAP_C, iterARAP_CP);
...
C2 = [iterARAP_D; 0; t_D];
C3 = [iterARAP_C; iterSchur_C; t_C];
C4 = [iterARAP_CP; iterSchur_CP; t_CP];
T = table(C2, C3, C4, 'VariableNames', {'Direct Solver', 'CG', 'PCG'});
