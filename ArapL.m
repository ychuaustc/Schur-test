%%  return arap transformation L and related values
%%
%%  Input:
%%          FXV:            x coordinate for each triangle in original Face
%%          FYV:            y coordinate for each triangle in original Face
%%          FXU:            x coordinate for each triangle in parameterized Face
%%          FYU:            y coordinate for each triangle in parameterized Face
%%          FCotTheta:      
%%          Face:           
%%          nV:             
%%          nF:             
...
%%
%   assemble diagonal matrix with cross covariance matrix and do SVD
